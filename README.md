...
[![Packagist](https://img.shields.io/badge/Packagist-v3.0.9-blue)](https://packagist.org/packages/konfig/splitit-web-php-guzzle6-sdk)
...
```json
{
  ...
  "require": {
    "konfig/splitit-web-php-guzzle6-sdk": "3.0.9"
  }
}
```
